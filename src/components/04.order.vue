                        ...
                        <div id="orderForm" name="orderForm" url>
                            ...
                            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                                ...
                                <el-form-item label="所属地区" prop="area">
                                    <VDistpicker @selected="selectedArea" :province="ruleForm.area.province.value" :city="ruleForm.area.city.value" :area="ruleForm.area.area.value"></VDistpicker>
                                </el-form-item>
                                ...
                                <ul class="item-box clearfix">
                                    ...
                                    <li>
                                        <label>
                                            <!-- <input name="express_id" type="radio" onclick="freightAmountTotal(this);" value="1" data-type="*" sucmsg=" ">
                                            <input name="express_price" type="hidden" value="20.00">顺丰快递
                                            <em>费用：20.00元</em>
                                            <span class="Validform_checktip"></span> -->
                                            <el-radio v-model="ruleForm.express_id" @change="ruleForm.expressMoment=24" label="1">顺丰</el-radio>&nbsp;&nbsp;
                                            <em>费用：24.00元</em> &nbsp;&nbsp;
                                            <el-radio v-model="ruleForm.express_id" @change="ruleForm.expressMoment=8" label="2">韵达</el-radio>&nbsp;&nbsp;
                                            <em>费用：8.00元</em> &nbsp;&nbsp;
                                            <el-radio v-model="ruleForm.express_id" @change="ruleForm.expressMoment=10" label="3">圆通</el-radio>&nbsp;&nbsp;
                                            <em>费用：10.00元</em> &nbsp;&nbsp;
                                            <span class="Validform_checktip"></span>
